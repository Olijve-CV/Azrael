...
namespace Lua
{
	...
	//get more information to visit:http://lua-users.org/wiki/CppBind
	template <typename T> 
	class Lunar 
	{
	...
	private:
	  ...
	  static int thunk(lua_State *L) {
		...
		return (obj->*(T::methods[i].mfunc))(L);//call memeber function
	  }
...
#define LUA_IMPLE(class,name) const char class::className[] = #name;
...
#define local(args, rets) Lua::scriptCall(_L, args, rets)
